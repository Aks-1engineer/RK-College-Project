...
$query="select * from tbl_academic where type='academic_calender'";
...
<div class="row bg-white mt-3">
  <h3 class="text-center">ACADEMIC CALENDER</h3>
  ...
  <table class="table">
    ...
    <tbody>
      <tr>
        <td><?php echo $a; ?></td>
        <td><a href="admin/naac/naac_file/<?php echo $row['file_name'];?>" target="_blank">click here to view</a></td>
  ...
  <!--explore more about RK college,madhubani end-->
   ...
   <!--footer start-->
   <div class="row footer-color mt-3">
    <div class="col-sm-2 ">
      <h6 class="pt-3 text-center">Useful Links:</h6>
      <hr/>
      <ul class="footer-icon">
        <li><a href="">Administration</a></li>
        <li><a href="">College Committees</a></li>
        <li><a href="">Facilities</a></li>
        <li><a href="">Admission</a></li>
        <li><a href="">National Library</a></li>
    ...
    <div class="col-sm-2">
      ...
      <ul class="footer-icon">
        ...
        <li><a href="">LNMU e-pathshala</a></li>
    ...
    <div class="col-sm-3">
      ...
      <ul class="footer-social-icon">
        <li><a href="https://www.facebook.com/rkcmadhubani/" target="_blank"><i class="fa-brands fa-facebook" title="facebook"></i></a></li>
        <li><a href=""><i class="fa-brands fa-twitter" title="twitter"></i></a></li>
        <li><a href="https://in.linkedin.com/school/r.-k.-college/" target="_blank"><i class="fa-brands fa-linkedin-in" title="linkedin"></i></a></li>
        <li><a href=""><i class="fa-brands fa-instagram" title="instagram"></i></a></li>
        <li><a href="https://groupsorlink.com/rk-college-whatsapp-group-link-study-material/" target="_blank"><i class="fa-brands fa-whatsapp" title="whatsapp"></i></a></li>
      </ul>
    </div>
    ...
    <div class="row footer-color py-3">
      ...
      <div class="col-sm-5 ">Powered by Softpro india computer technologie (p) Ltd.</div>
    </div>
   <!--footer end-->
