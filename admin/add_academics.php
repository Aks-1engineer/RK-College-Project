        ...
        <div class="row mx-1 mt-1">
            ...
            <div class="col-sm-9 bg-white">
                <div class="row bg-white">
                 ...
                 <div class="row">
                  <div class="col-sm-12">
                    <form action="academic_code.php" method="post" enctype="multipart/form-data">
                       <h3 class="text-center"><b><i>ACADEMICS</i></b></h3>
                       Session 
                       <input type="text" placeholder="write session" name="session" class="form-control mb-3">
                       File 
                       <input type="file" name="file" class="form-control mb-3" required>
                       <select name="session_value" id="" class="form-control">
                        <option value="" class="form-control">--select--</option>
                        <option value="academic_calender">Academic calender</option>
