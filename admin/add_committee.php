...
{
include("connection.php");
$query2="insert into tbl_committee(committee_name,created_at) value('$committee_name',now())";
                 ...
                 <div class="row">
                  <div class="col-sm-12">
                   ...
                   echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Alert!</strong> Please First Write Committee Name.
                    ...
                    <form action="add_committee.php" method="post" enctype="multipart/form-data">
                       <h3 class="text-center"><b><i>COMMITTEE</i></b></h3>
                       Committee Name 
                       <input type="text" placeholder="Enter committee name" name="committee_name" class="form-control mb-3">
                       <input type="submit" value="Add Committee" name="submit">
                       <?php  
                                 if($success)
                                 {
                                echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                 <strong>Alert!</strong> Committee name saved successfully.
                                 <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                               </div>';
                            }
                            ?>
