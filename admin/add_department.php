...
if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  include("connection.php");
  $query2="insert into tbl_department(dep_name,date) value('$department',now())";
                 ...
                 <!-- dashboard info-->
                   <form action="add_department.php" method="post">
                    <h4 class="text-center">Add Department</h4>
                      ...
                      <input type="submit" value="Add" class="btn bg-success mt-2 text-center px-5">
                      <br>
                      <?php
if($ok)
{
echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
<strong>Alert!</strong> Department added successfully.
