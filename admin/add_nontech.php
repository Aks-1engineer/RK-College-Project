...
//echo $address;
include("connection.php");
$query2="insert into tbl_nonteacher(name,fname,dob,designation,gender,dept_name,qualification,mobile,pic,email,address,dor) 
...
<body class="Dashboard">
        ...
        <div class="row mx-1 mt-1">
            ...
            <div class="col-sm-9 bg-white">
                <div class="row bg-white">
                 ...
                 <!-- dashboard info-->
                 <div class="row">
                    <h3 class="text-center"><b><i>Add Non-teaching Staff</i></b></h3>
                 <?php
                   if($nonteacher)
                    {
                     echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
   <strong>Alert!</strong> Non-Teaching Staff added successfully.
   <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    ...
                    ?>
                           <div class="col-sm-6">
                           <form action="add_nontech.php" method="post" enctype="multipart/form-data">
                         ...
                         <input type="text" placeholder="Enter date of birth" name="dob" class="form-control mb-2" required>
                           ...
                           <div class="col-sm-6">
                               ...
                               <input type="text" placeholder="Enter department" name="department" class="form-control mb-2" required>
