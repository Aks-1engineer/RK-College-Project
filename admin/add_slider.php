...
if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  //echo $tmp_name;
  include("connection.php");
  $query2="insert into tbl_slider(text1,text2,pic,date) value('$title1','$title2','$slider_image',now())";
  $res2=mysqli_query($con,$query2);
  //header("location:add_gallery.php");
  $location="slider/".$slider_image;
  //echo $location;
                    ...
                    <div class="col-sm-12">
                          ...
                          <div class="btn-group dropend">
                            ...
                            <ul class="dropdown-menu dropdown-bg form-control text-center">
                              ...
                              <li><a class="dropdown-item" href="view_academics.php">View Academics</a></li>
                            </ul>
                          </div>
                          ...
                          <div class="btn-group dropend">
                            ...
                            <ul class="dropdown-menu dropdown-bg form-control text-center">
                              ...
                              <li><a class="dropdown-item" href="academic_show.php">View Slider</a></li>
                            </ul>
                          </div>
                          <div class="btn-group dropend">
                            <button type="button" class="btn logout  dropdown-toggle mb-1 pt-0 text-start" data-bs-toggle="dropdown" aria-expanded="false">
...
<strong>Alert!</strong> Slider added successfully.
                 ...
                 ?>
                  <div class="col-sm-12">
                    <form action="add_slider.php" method="post" enctype="multipart/form-data">
                        <h3 class="text-center"><b><i>Add Images in slider</i></b></h3>
                        <input type="text" name="title1" placeholder="Enter first title" class="form-control mt-3">
                        <input type="text" name="title2" placeholder="Enter second title" class="form-control mt-3">
                        <input type="file" name="slider_image" class="form-control mt-3" required>
