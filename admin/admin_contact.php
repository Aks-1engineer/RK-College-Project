        ...
        <div class="row mx-1 mt-1">
            ...
            <div class="col-sm-9 bg-white">
                <div class="row bg-white">
                 ...
                 <?php
                 include("connection.php");
                 $query2="select * from tbl_contact";
                 $res2=mysqli_query($con,$query2);
                 ?>
                 
<div class="container mt-3">
  <h3 class="text-center">All Details of submitted messages</h3>           
  <table class="table">
    <thead>
      <tr>
        <th>S.no</th>
    ...
    <tbody>
      <tr>
        ...
        <td><a href="feedback.php">Send</a></td>
        <td><a href="message_delete.php?con_id=<?php echo $row2['0']; ?>" ><i class="fa-solid fa-trash"></i></a></td>
