                    ...
                    <div class="row">
                        ...
                        <?php  
                                ...
                                echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                 <strong>Alert!</strong>  Your old password and new password is same.
                                 <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                               </div>';
                            }
                               else if($npandcnpnotsame)
                               {
                                echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                 <strong>Alert!</strong>  Your new password and confirm new password is not same.
                                 <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                               </div>';
                               }
                               else
                               {
                                echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                 <strong>Alert!</strong> Your Old password is wrong.
                                 <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                               </div>';
                               }
                                 ?>
                            ...
                            <form action="change.php" method="post">
                              Old Password
                                <input type="password" placeholder="Enter Old Password" name="op" class="form-control" required>
                               
                                 New Password:
                                <input type="password" placeholder="Enter New Password" name="np" class="form-control" required>
                                Confirm New Password:
                                <input type="password" placeholder="Enter Again New Password" name="cnp" class="form-control" required>
                               <p class="text-center"> <input type="submit" class="btn bg-success text-white mt-2" value="Change Password"> </p>
