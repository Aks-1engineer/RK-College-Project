...
$query1 = "update tbl_admin set date=now() where email='$email'";
    ...
    <div class="row mx-1 mt-1">
      <div class="col-sm-3 left-side-col">
        <div class="row">
          ...
          <div class="row">
            <div class="col-sm-12">
              <p class="pb-0 text-white text-center">R.K.College Madhubani(Bihar)</p>
            </div>
          </div>
        </div>
        <hr>
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <input type="text" value="<?php echo $curdate; ?>" class="w-100 left-side-col text-white "
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="btn-group dropend">
              <button type="button" class="btn logout  dropdown-toggle mb-1 pt-0 text-start" data-bs-toggle="dropdown"
                aria-expanded="false">
                Notification
              </button>
      ...
      <div class="col-sm-9 bg-white">
        <div class="row bg-white">
          <div class="col-sm-7 text-center">
            <marquee behavior="" direction="">Welcome to Admin panel</marquee>
          </div>
          <div class="col-sm-2">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 p-2 mt-1 text-white footer text-center">Copyright © | R.K. College,Madhubani(Bihar)|
            Designed and Developed by Amit kumar sharma</div>
        </div>
      </div>
    </div>
  </div>
