        ...
        <div class="row mx-1 mt-1">
            ...
            <div class="col-sm-9 bg-white">
                <div class="row bg-white">
                 ...
                 //echo $dep_id;
                 include("connection.php");
                 $query2="select * from tbl_department where dep_id='$dep_id'";
                 ...
                 ?>
                    ...
                    <div class="col-sm-12">
                       ...
                       <form action="dep_update.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="dep_id" value="<?php echo $row2['dep_id'];   ?>">
                        <h3 class="text-center"><b><i>Update Department</i></b></h3>
                        <input type="text" name="dep_name" class="form-control" value="<?php echo $row2['dep_name']; ?>">
                        <div class="row">
                               <div class="col-sm-12 text-center my-3">
                               <input type="submit" class="btn btn-success px-5" value="Update Department" >
