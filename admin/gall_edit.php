        ...
        <div class="row mx-1 mt-1">
            ...
            <div class="col-sm-9 bg-white">
                <div class="row bg-white">
                 ...
                 //echo $non_id;
                 include("connection.php");
                 $query2="select * from tbl_gallery where gall_id='$gall_id'";
                 $res2=mysqli_query($con,$query2);
                 if($row2=mysqli_fetch_array($res2))
                 {
                 ?>
                         <div class="row">
                    <h3 class="text-center"><b><i>Update Images of gallery</i></b></h3>
                           <div class="col-sm-12">
                           <form action="gallery_update.php" method="post" enctype="multipart/form-data">
                               <input type="hidden" name="gall_id" value="<?php echo $row2['gall_id']; ?>" />
                               Title
                               <input type="text" value="<?php echo $row2['text1']; ?>" name="title" class="form-control mb-2">
   
                               Upload a Image
                               <input type="file" value="" name="gall_img_name" class="form-control mb-2">
