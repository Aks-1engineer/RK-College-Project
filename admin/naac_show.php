...
<strong>Congratulation!</strong> NAAC file saved successfully.
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  ...
  <h3 class="text-center">All Record Releted to NAAC</h3>           
  ...
  while($row2=mysqli_fetch_array($res2))
  {
    ...
    <tbody>
      <tr>
        ...
        <td><a href="naac/naac_file/<?php echo $row2['2']; ?>">click here to view</a></td>
