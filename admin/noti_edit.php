        ...
        <div class="row mx-1 mt-1">
            ...
            <div class="col-sm-9 bg-white">
                <div class="row bg-white">
                 ...
                 //echo $noti_id;
                 include("connection.php");
                 $query2="select * from tbl_notification where noti_id='$noti_id'";
                 ...
                 ?>
                    ...
                    <div class="col-sm-12">
                       ...
                       <form action="noti_update.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="noti_id" value="<?php echo $row2['noti_id'];   ?>">
                        Add Notification:
                        <input type="text" name="notification" class="form-control" value="<?php echo $row2['notification']; ?>">
                        <br>
                        Upload Pdf File:
                        <input type="file" name="file" class="form-control">
                        <div class="row">
                               <div class="col-sm-12 text-center my-3">
                               <input type="submit" class="btn btn-success px-5" value="Update Notification" >
