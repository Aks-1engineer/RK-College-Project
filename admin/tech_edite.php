        ...
        <div class="row mx-1 mt-1">
            ...
            <div class="col-sm-9 bg-white">
                <div class="row bg-white">
                 ...
                 //echo $tech_id;
                 include("connection.php");
                 $query2="select * from tbl_teacher where tech_id='$tech_id'";
                 $res2=mysqli_query($con,$query2);
                 if($row2=mysqli_fetch_array($res2))
                 {
                 ?>
                         <div class="row">
                    <h3 class="text-center"><b><i>Update Teaching Staff</i></b></h3>
                           <div class="col-sm-6">
                           <form action="tech_update.php" method="post" enctype="multipart/form-data">
                               <input type="hidden" name="tech_id" value="<?php echo $row2['tech_id']; ?>" />
                               Name
