        ...
        <div class="row mx-1 mt-1">
            ...
            <div class="col-sm-9 bg-white">
                <div class="row bg-white">
                 ...
                 <?php
                 include("connection.php");
                 $query2="select * from tbl_committee_member";
                 $res2=mysqli_query($con,$query2);
                 ?>
                 
<div class="container mt-3">
  <h3 class="text-center"><b><i>All MEMBER OF COMMITTEE</i></b></h3>           
  <table class="table">
    <thead>
      <tr>
        <th>S.no</th>
    ...
    <tbody>
      <tr>
        ...
        //echo $row2['cc_id']; 
        include("connection.php");
      $query4='select * from tbl_committee where cc_id=<?php echo $row2["cc_id"]; ?>'; 
        $res4=mysqli_connect($con,$query4);
       if($row4=mysqli_fetch_array($res4))
       {
          echo $committee_name='<?php echo $row4["committee_name"]; ?>';
       }
        ?> </td>
        <td><?php echo $row2['date'];  ?></td>
        <td><a href="mem_delete.php?mem_id=<?php echo $row2['mem_id']; ?>" ><i class="fa-solid fa-trash"></i></a></td>
        <td><a href="mem_edit.php?mem_id=<?php echo $row2['mem_id']; ?>" ><i class="fa-solid fa-pen-to-square"></i></a></td>
      </tr>
