...
<div class="container mt-3">
  <h3 class="text-center">All Committee</h3>           
  <table class="table">
    <thead>
      <tr>
        <th>S.no</th>
    ...
    <tbody>
      <tr>
        <td><?php echo $a; ?> </td>
        <td><?php echo $row2['committee_name']; ?></td>
        <td><?php echo $row2['created_at'];  ?></td>
        <td><a href="committee_delete.php?cc_id=<?php echo $row2['cc_id']; ?>" ><i class="fa-solid fa-trash"></i></a></td>
        <td><a href="committee_edit.php?cc_id=<?php echo $row2['cc_id']; ?>" ><i class="fa-solid fa-pen-to-square"></i></a></td>
      </tr>
