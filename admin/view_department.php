  ...
  <table class="table">
    ...
    <tbody>
      <tr>
        ...
        <td><a href="dep_delete.php?dep_id=<?php echo $row2['dep_id']; ?>" ><i class="fa-solid fa-trash"></i></a></td>
        <td><a href="dep_edit.php?dep_id=<?php echo $row2['dep_id']; ?>" ><i class="fa-solid fa-pen-to-square"></i></a></td>
      </tr>
