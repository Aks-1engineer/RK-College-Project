        ...
        <div class="row mx-1 mt-1">
            ...
            <div class="col-sm-9 bg-white">
                <div class="row bg-white">
                 ...
                 <?php
                 include("connection.php");
                 $query2="select * from tbl_slider";
                 $res2=mysqli_query($con,$query2);
                 ?>
                 
<div class="container mt-3">
  <h3 class="text-center">All Details of Slider</h3>           
  <table class="table">
    <thead>
      <tr>
        <th>S.no</th>
    ...
    <tbody>
      <tr>
        <td><?php echo $a;  ?> </td>
        <td><img src="slider/<?php echo $row2['pic'];?>" height="100px" width="100px"/></td>
        <td><?php echo $row2['text1'];  ?></td>
        <td><?php echo $row2['text2']  ?></td>
        <th><?php echo $row2['date']  ?></th>
        <td><a href="slider_delete.php?slider_id=<?php echo $row2['0']; ?>" ><i class="fa-solid fa-trash"></i></a></td>
        <td><a href="slider_edit.php?slider_id=<?php echo $row2['0']; ?>" ><i class="fa-solid fa-pen-to-square"></i></a></td>
      </tr>
