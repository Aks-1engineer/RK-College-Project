  ...
  <table class="table">
   ...
   ?>
    <tbody>
      <tr>
        <td><?php echo $a;   ?></td>
        <td><img src="teacher/image/<?php echo $row2['pic'];?>" height="100px" width="100px"/></td>
        ...
        <td> <a href="tech_delete.php?tech_id=<?php  echo $row2['tech_id']; ?>"><i class="fa-solid fa-trash"></i></a></td>
        <td><a href="tech_edite.php?tech_id=<?php  echo $row2['tech_id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
      </tr>
