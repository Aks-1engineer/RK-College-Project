...
<head>
  ...
  <title>ARTS DEPARTMENT|| RK COLLEGE</title>
</head>

<body style="background-color:#ffd560;">
 ...
 <div class="row sticky-top mt-3">
    ...
    <!--about section start-->
      <div class="row mt-3 menubar">
        <div class="col-sm-12">
        <h4 class="text-center text-white" ><b><i>ARTS DEPARTMENT</i></b></h4>
        </div>
       </div>
             <div class="row">
                <div class="col-sm-12 mt-3 text-center course-border">
               <img src="images/history.jfif" class="d-block mx-auto course-height" alt="">
               <h4>History</h4>
               <h6>Department</h6>
             ...
             <div class="col-sm-12 mt-3 text-center course-border">
               <img src="images/geography.jfif" class="d-block mx-auto course-height" alt="">
               <h4>Geography</h4>
               <h6>Department</h6>
               <p><a href="#" class="btn btn-border">Read more</a></p>
             </div>
             ...
             <div class="col-sm-12 mt-3 text-center course-border">
               <img src="images/economics.jpg" class="d-block mx-auto course-height" alt="">
               <h4>Economics</h4>
               <h6>Department</h6>
               <p><a href="#" class="btn btn-border">Read more</a></p>
             </div>
             ...
             <div class="col-sm-12 mt-3 text-center course-border">
               <img src="images/psychology.jpeg" class="d-block mx-auto course-height" alt="">
               <h4>Psychology</h4>
               <h6>Department</h6>
               <p><a href="#" class="btn btn-border">Read more</a></p>
             </div>
