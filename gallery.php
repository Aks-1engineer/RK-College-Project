...
<body style="background-color:#14f775;">
 ...
 <div class="row sticky-top mt-3">
    ...
    <!--
     <div class="container">
        <div class="row">
            <div class="col-sm-12"><marquee behavior="" direction=""><img src="images/gallery/gal1.jpg" height="150px" width="150px" alt=""></marquee></div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <img src="images/gallery/gal9.jpg" alt="">
            </div>
            <div class="col-sm-4">
        ...
        <div class="row">
            <div class="col-sm-12">
                <marquee behavior="" direction=""><img src="images/gallery/gal17" height="150px" width="150px" alt=""></marquee>
            </div>
        </div>
     </div>-->
     <div class="row mt-3 bg-white">
      <div class="col-sm-12 mt-2  footer-color text-center">
        <h3><b><i>Gallery</i></b></h3>
      </div>
     <div class="col-sm-12" style="background-color:#c6d8e6;">
     <?php
      ...
      {
        ?>
<img src="admin/gallery/<?php echo $row['gall_img_name']; ?>" height="350px" width="350px" class="mt-3 ms-3 border border-5">
