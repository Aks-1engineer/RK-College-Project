...
<head>
  ...
  <title>NON-TEACHING STAFF COLLEGE|| RK COLLEGE</title>
</head>

<body style="background-color:#175580ae;">
 ...
 <div class="row sticky-top mt-3">
    ...
    <!--about section start-->
    <div class="row mt-3">
        <div class="col-sm-12 text-center footer-color text-white"><h3><b><i>Non-Teaching Staff Details</i></b></h3></div>
     </div>
  ...
  <table class="table table-bordered">
    ...
    <tbody>
      <tr>
        <td><?php echo $a; ?></td>
        <td><img src="admin/Non-teaching/images/<?php echo $row['pic']; ?>" height="100px" width="150px" alt=""></td>
