...
<head>
  ...
  <title>ABOUT || RK COLLEGE</title>
</head>

<body style="background-color:#5555;">
 ...
 <div class="row sticky-top mt-3">
    ...
    <!--about section start-->
      <div class="row mt-3 menubar">
        <div class="col-sm-12">
        <h4 class="text-center text-white" ><b><i>SCIENCE DEPARTMENT</i></b></h4>
        </div>
       </div>
             <div class="row">
                <div class="col-sm-12 mt-3 text-center course-border">
               <img src="images/Math Department.jpg" class="d-block mx-auto course-height" alt="">
               <h4>Mathematics</h4>
               <h6>Department</h6>
               <p><a href="#" class="btn btn-border">Read more</a></p>
             </div>
               
             <div class="col-sm-12 mt-3 text-center course-border">
               <img src="images/physics.jfif" class="d-block mx-auto course-height" alt="">
               <h4>Physics</h4>
               <h6>Department</h6>
               <p><a href="#" class="btn btn-border">Read more</a></p>
             </div>
             ...
             <div class="col-sm-12 mt-3 text-center course-border">
               <img src="images/chemistry.jpg" class="d-block mx-auto course-height" alt="">
               <h4>Chemistry</h4>
               <h6>Department</h6>
               <p><a href="#" class="btn btn-border">Read more</a></p>
             </div>
             ...
             <div class="col-sm-12 mt-3 text-center course-border">
               <img src="images/botany.jfif" class="d-block mx-auto course-height" alt="">
               <h4>Botany</h4>
               <h6>Department</h6>
               <p><a href="#" class="btn btn-border">Read more</a></p>
             </div>
             ...
             <div class="col-sm-12 mt-3 text-center course-border">
               <img src="images/zoology.jfif" class="d-block mx-auto course-height" alt="">
               <h4>Zoology</h4>
               <h6>Department</h6>
               <p><a href="#" class="btn btn-border">Read more</a></p>
             </div>
             
              <div class="col-sm-12 menubar  mt-3">
                <h4 class="text-center"><a href="see_all_courses.php" class="text-white w-100"><b><i>See All Courses</i></b></a></h4>
                </div>
