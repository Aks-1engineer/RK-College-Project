...
<head>
  ...
  <title>ALL COURSES DETAILS || RK COLLEGE</title>
</head>

<body style="background-color:#7c829f;">
 ...
 <div class="row sticky-top mt-3">
    ...
    <!--about section start-->
      <div class="row mt-3 menubar">
        <div class="col-sm-12">
        <h4 class="text-center text-white" ><b><i>ALL COURSES DETAILS</i></b></h4>
        </div>
       </div>
         ...
         <div class="row mt-3">
             <div class="col-sm-6 text-center course-border">
               <img src="images/mentor/course/course-removebg-preview.png" class="d-block mx-auto course-height" alt="">
               <h4>I.Sc</h4>
               <h6>Duration:2 Years</h6>
               <p><a href="" class="btn btn-border">Read more</a></p>
             </div>
             <div class="col-sm-6 text-center courses-background course-border">
               <img src="images/mentor/course/course-removebg-preview.png" class="d-block mx-auto course-height" alt="">
               <h4>I.COM</h4>
               <h6>Duration:2 Years</h6>
               <p><a href="" class="btn btn-border">Read more</a></p>
